...
<div id="wide" class="wide">
					...
					<table width="100%">
						<tr>
							...
							<td style="min-width:312px;">
								...
								<p><%==trans("MES_CONTACT_SUPPORT")%>: <a href="mailto:support@drakonhub.com">support@drakonhub.com</a><br /></p>
								<div style="height:20px;"></div>
		...
		<div>
			<div class="center" style="padding-top:40px; color:#8b0000; max-width:768px; text-align:center; padding-bottom:20px; line-height:130%; font-size:90%;">
				...
				<a style="color:#8b0000;" href="mailto:support@drakonhub.com">support@drakonhub.com</a><br />
