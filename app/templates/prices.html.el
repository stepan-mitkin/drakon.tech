...
<div id="ui">
	<div id="narrow" class="mobile_only">
		...
		<div class="" style="background:white;">			
				...
				<p style="padding-bottom:10px; text-align:left;"><%=trans("MES_DEW_IS_FREE_FOR_STUDENTS")%> <a style="color:#8b0000;" href="mailto:support@drakonhub.com">support@drakonhub.com</a>.</p>			
		</div>
		

		<div class="center" style="padding-top:70px; color:#8b0000; text-align:center; padding-bottom:20px;">
			<%=trans("Feedback")%>: <a style="color:#8b0000;" href="mailto:support@drakonhub.com">support@drakonhub.com</a>
