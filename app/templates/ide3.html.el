...
@font-face {
	font-family: 'Cousine';
	src: url('/static/fonts/Cousine-Regular.ttf') format('truetype');
}
...
<div id="loading" class="full_screen" style="background:black;">
	<div style="width:160px; position:absolute; left:calc(50% - 80px); top:calc(50vh - 97px);">
		...
		<div style="color:#00a7e1; text-align:center; font-size:25px; font-family:Cousine"><%=trans("loading")%></div>
	</div>
</div>
