...
% if language == "ru" then
<title>Добро пожаловать в Дракон-Тех</title>
% else
<title>Welcome to Drakon.Tech</title>
% end
...
<h1 style="margin-top:10px;">Добро пожаловать в Дракон-Тех!</h1>
...
<div id="open_editor" style="margin:auto; max-width:400px; margin-top:30px; display:none;">
...
<div id="learn_more" style="margin:auto; max-width:400px; margin-top:30px; display:none;">
	<a id="learn_more_link" class="panic_button" style="margin-left:5px; margin-right:5px; background:coral; " onclick="">Начать</a>
</div>

% else

<h1 style="margin-top:10px;">Welcome to Drakon.Tech!</h1>
...
<div id="learn_more" style="margin:auto; max-width:400px; margin-top:30px; display:none;">
	<a id="learn_more_link" class="panic_button" style="margin-left:5px; margin-right:5px; background:coral; " onclick="">Get started</a>
</div>
...
function start() {
	...
	var next = getQueryParameter("next")
	if (next) {
		get("open_editor").style.display = "none"
		get("learn_more").style.display = "block"
		get("learn_more_link").href = next
	} else {
		get("open_editor").style.display = "block"
		get("learn_more").style.display = "none"
	}
}
